...
for algo in algos:
    ...
    adapt_recall_ci = st.t.interval(0.95, n-1, loc=adapt_recall_mean, scale=adapt_recall_se)
    
    print(f"\n{algo}:")
    print(f"  Base FPR: Mean={base_fpr_mean:.4f}, Std={base_fpr_std:.4f}, 95% CI=[{base_fpr_ci[0]:.4f}, {base_fpr_ci[1]:.4f}]")
    print(f"  Adapt FPR: Mean={adapt_fpr_mean:.4f}, Std={adapt_fpr_std:.4f}, 95% CI=[{adapt_fpr_ci[0]:.4f}, {adapt_fpr_ci[1]:.4f}]")
    print(f"  Adapt Recall: Mean={adapt_recall_mean:.4f}, Std={adapt_recall_std:.4f}, 95% CI=[{adapt_recall_ci[0]:.4f}, {adapt_recall_ci[1]:.4f}]")
